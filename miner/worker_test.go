...
func newTestWorkerBackend(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, db ethdb.Database, n int) *testWorkerBackend {
	...
	chain, err := core.NewBlockChain(db, &core.CacheConfig{TrieDirtyDisabled: true}, gspec, nil, engine, vm.Config{EnableParallelExec: true, ParallelTxNum: 8}, nil, nil)
	if err != nil {
...
func TestGenerateAndImportBlock(t *testing.T) {
	...
	chain, _ := core.NewBlockChain(rawdb.NewMemoryDatabase(), nil, b.genesis, nil, engine, vm.Config{EnableParallelExec: true, ParallelTxNum: 8}, nil, nil)
	defer chain.Stop()
