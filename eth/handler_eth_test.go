...
func testForkIDSplit(t *testing.T, protocol uint) {
	...
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, nil, gspecNoFork, nil, engine, vm.Config{EnableParallelExec: true, ParallelTxNum: 8}, nil, nil)
		chainProFork, _ = core.NewBlockChain(dbProFork, nil, gspecProFork, nil, engine, vm.Config{EnableParallelExec: true, ParallelTxNum: 8}, nil, nil)
